...
- **Comments:** readers can comment on articles; every comment waits in the
  admin's Comments tab until you approve it. Honeypot and rate-limiting keep
  casual spam out; switch comments off entirely in Settings.
