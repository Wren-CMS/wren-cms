...
- **Pages** appear in the site menu (order them with *menu position*, and
  ...
  link with a blank URL becomes a heading-only item for grouping, and any menu
  link can be set to open in a new tab.
...
Search, multiple authors, export. Deliberately *not* on the roadmap: plugins,
page builders, visitor accounts, anything that would mean Wren no longer fits
in your head.
